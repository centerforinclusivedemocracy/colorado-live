...
const PARTICIPATING_COUNTIES = [
    ...
    { countyfp: "005", name: "Arapahoe", profile: 'fullmodel', outoforder:"", datafootnote:"" , exceptlayers: [] },
    { countyfp: "013", name: "Boulder", profile: 'fullmodel', outoforder:"", datafootnote:"" , exceptlayers: [] },
    { countyfp: "014", name: "Broomfield", profile: 'fullmodel', outoforder:"", datafootnote:"" , exceptlayers: [] },
    { countyfp: "031", name: "Denver", profile: 'fullmodel', outoforder:"", datafootnote:"" , exceptlayers: [] },
    { countyfp: "035", name: "Douglas", profile: 'fullmodel', outoforder:"", datafootnote:"" , exceptlayers: [] },
    { countyfp: "037", name: "Eagle", profile: 'fullmodel', outoforder:"", datafootnote:"" , exceptlayers: [] },
    { countyfp: "041", name: "El Paso", profile: 'fullmodel', outoforder:"", datafootnote:"" , exceptlayers: [] },
    { countyfp: "043", name: "Fremont", profile: 'fullmodel', outoforder:"", datafootnote:"" , exceptlayers: [] },
    { countyfp: "045", name: "Garfield", profile: 'fullmodel', outoforder:"", datafootnote:"" , exceptlayers: [] },
    { countyfp: "059", name: "Jefferson", profile: 'fullmodel', outoforder:"", datafootnote:"" , exceptlayers: [] },
    { countyfp: "067", name: "La Plata", profile: 'fullmodel', outoforder:"", datafootnote:"" , exceptlayers: [] },
    { countyfp: "069", name: "Larimer", profile: 'fullmodel', outoforder:"", datafootnote:"" , exceptlayers: [] },
    { countyfp: "077", name: "Mesa", profile: 'fullmodel', outoforder:"", datafootnote:"" , exceptlayers: [] },
    { countyfp: "101", name: "Pueblo", profile: 'fullmodel', outoforder:"", datafootnote:"" , exceptlayers: [] },
    { countyfp: "123", name: "Weld", profile: 'fullmodel', outoforder:"", datafootnote:"" , exceptlayers: [] },
];
...
DATA_LAYERS.one_day_sites = {
    id: 'one_day_sites',
    title: "Suggested Areas for 1 Day Vote Centers",
    csvfile: 'model_files/one_day_sites.csv',
    ...
    downloadfile: 'model_files/one_day_sites_shp.zip',
};
DATA_LAYERS.fifteen_day_sites = {
    id: 'fifteen_day_sites',
    title: "Suggested Areas for 15 Day Vote Centers",
    csvfile: 'model_files/fifteen_day_sites.csv',
    circle: { radius: 400, opacity: 0.8, color: 'black', weight: 1, fillColor: 'quantile', fillOpacity: 0.8 },
    quantilefield: 'center_score', quantilecolors: SCORING_COLOR_RAMP, breaksource: 'sitescores', // because fillColor == quantile
    mapzindex: 'high',
    legendformat: 'lowtohigh',
    downloadfile: 'model_files/fifteen_day_sites_shp.zip',
};
...
// some new data layers custom to this state

DATA_LAYERS.fixed_sites = {
    id: 'fixed_sites',
    title: "Fixed Voter Service and Polling Centers",
    csvfile: 'point_files/fixed_sites.csv',
    circle: { color: '#914df0', fillColor: '#914df0', fillOpacity: 0.6, radius: 25, opacity: 1 },
    popupnamefield: 'name',
    popuptypetext: 'Fixed Voter Service and Polling Center',
    mapzindex: 'highest',
    downloadfile: 'point_files/fixed_sites.csv',
};
...
DATA_PROFILES.fullmodel = {
    suggestedareas: [
        DATA_LAYERS.one_day_sites, DATA_LAYERS.fifteen_day_sites, DATA_LAYERS.dropbox_sites, DATA_LAYERS.all_sites_scored,
    ],
    additionalareas: [
